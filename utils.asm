...
# purpose: To print a string and an int to the console
# input: $a0 - The string to print before the int.
#        $a1 - The int to print
# returns: None
...
# subprogram: Mult4
# author: Perry Copus
# purpose: multiply a positive integer by 4
# input: $v0 - number to multiply
# output: $v0 - the input multiploied by 4
# side effects: none
Mult4:
  sll $v0, $v0, 2
  jr $ra
